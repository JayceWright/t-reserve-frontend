...
export class HeroComponent implements AfterViewInit, OnDestroy {
  ...
  buyTicket(): void {
    ...
    this.btnBuyText = 'TRANSMITTING ALLOCATION REQUEST...';

    setTimeout(() => {
      this.btnBuyText = 'TRANSACTION REGISTERED ✓';
      this.capacityPercentage = 100;
      this.filledBlocksCount = 10;

      // Pulse a HUD message (emulated by toast or UI state in future)
      this.createHUDToast('BOOKING VERIFIED: Routing queue resolved.', 'gold');
